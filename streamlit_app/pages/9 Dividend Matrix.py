...
def get_stock_data(ticker):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            title = tree.xpath('/html/body/div/div[1]/div[2]/main/div[1]/div[1]/div[1]/h1/text()')[0]
            ...
            return {"Ticker": ticker, "Title": title, "Price": price, "Yield %": yield_percent, "Annual Dividend": annual_dividend, "Ex Dividend Date": ex_dividend_date, "Frequency": frequency, "Dividend Growth %": dividend_growth}
        else:
            ...
            if response.status_code == 200:
                ...
                return {"Ticker": ticker, "Title": "N/A", "Price": "N/A", "Yield %": "N/A", "Annual Dividend": "N/A", "Ex Dividend Date": "N/A", "Frequency": "N/A", "Dividend Growth %": "N/A"}
    except:
        return {"Ticker": ticker, "Title": "N/A", "Price": "N/A", "Yield %": "N/A", "Annual Dividend": "N/A", "Ex Dividend Date": "N/A", "Frequency": "N/A", "Dividend Growth %": "N/A"}
